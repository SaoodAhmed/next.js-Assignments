...
//import Logo from "../../images/skills/java.png";
...
const Navbar = () => {
  ...
  return (
    <nav className="  mx-auto  fixed top-px w-full bg-gray-900 z-20 md:container-xl md:flex items-center justify-between md:px-20 text-gray-200  px-4    ">
